CREATE PROCEDURE [dbo].[EPG_History_InsertUpdate_old]
...
BEGIN
    ...
    IF OBJECT_ID('tempdb..#ProgramInformationDataTable') IS NOT NULL
        DROP TABLE #ProgramInformationDataTable

    IF OBJECT_ID('tempdb..#GroupInformationDataTable') IS NOT NULL
        DROP TABLE #GroupInformationDataTable

    IF OBJECT_ID('tempdb..#ProgramScheduleDataTable') IS NOT NULL
        DROP TABLE #ProgramScheduleDataTable

    IF OBJECT_ID('tempdb..#ServiceInformationDataTable') IS NOT NULL
        DROP TABLE #ServiceInformationDataTable

    --Start ProgramInformationData insert into templary table from xml
    CREATE TABLE #ProgramInformationDataTable (
    ...
    CREATE TABLE #GroupInformationDataTable (
        [id]                 INT            IDENTITY (1, 1) NOT NULL,
    ...
    CREATE TABLE #ProgramScheduleDataTable (
        [id]                     INT            IDENTITY (1, 1) NOT NULL,
    ...
    CREATE TABLE #ServiceInformationDataTable (
        [id]                    INT           IDENTITY (1, 1) NOT NULL,
